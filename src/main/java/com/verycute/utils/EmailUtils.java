...
public class EmailUtils {
    ...
    public static void sendEmail(String fromEmail, String password, String toEmail, String subject, String message, String host, String port, ArrayList<String> attachmentPathList) throws MessagingException {
        // 邮件发送者信息
    ...
    public static void main(String[] args) throws MessagingException {
        ...
        String port = "465";
        ArrayList<String> attachment = new ArrayList<>(Arrays.asList("D:\\test.txt","D:\\test.bin"));
